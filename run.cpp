...
//    srand(time(NULL));
	...
	system("pause"); //REMOVE THIS LINE BEFORE SUBITMITING
    return 0;
}
...
bool sample1() {
	...
	cout << "Did my testFactory Pass for sample1? ::" << pass << endl; 
...
bool sample2() {
    ...
    bool pass = testFactory(numberOfShipments, sizeOfFireworkShipment, sizeOfMetalShipment, purchaseSize, numberOfPurchases, false);
	cout << "Did my testFactory Pass for sample2? ::" << pass << endl;
	cout << "Total number of Firework ::" << Firework::getTotalFireworks() << endl;
